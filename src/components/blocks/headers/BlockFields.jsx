...
export function StateVarField({ block, onUpdate }) {
  return (
...
export function FunctionField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-2 flex-1 flex-wrap" onMouseDown={(e) => e.stopPropagation()}>
            <select
              className="font-code bg-[#1a1a1a] border border-white/10 outline-none text-[12px] text-[#6ed668] rounded-md px-2 py-1 cursor-pointer font-bold appearance-none hover:bg-[#252525] transition-all uppercase w-[85px] h-[28px] text-left"
...
export function MappingField({ block, onUpdate }) {
  return (
                ...
                <div key={idx} className="flex items-center gap-1">
                  ...
                  {idx === arr.length - 2 && (
                    <button
                      onClick={() => {
                        const newTypes = [...(block.data?.types || ["address", "uint256"])];
                        newTypes.splice(idx + 1, 0, "address"); // Insert new key.
                        onUpdate(block.id, { types: newTypes });
                      }}
...
export function WhileField({ block, onUpdate }) {
  return (
...
export function ForField({ block, onUpdate }) {
  return (
...
export function IfElseIfField({ block, onUpdate }) {
  return (
...
export function TernaryField({ block, onUpdate }) {
  return (
...
export function ArrayField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-1 ml-1 flex-1 flex-wrap" onMouseDown={(e) => e.stopPropagation()}>
            {!block.data?.isCustomType ? (
              <select
...
export function EnumField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-2 flex-1 flex-wrap" onMouseDown={(e) => e.stopPropagation()}>
            <input
...
export function UserDefinedValueTypeField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-1 ml-1 flex-1 flex-wrap" onMouseDown={(e) => e.stopPropagation()}>
...
export function LibraryField({ block, onUpdate }) {
  return (
    <input
...
export function StructField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-2 flex-1 flex-wrap" onMouseDown={(e) => e.stopPropagation()}>
            <input
...
export function ModifierCommentLogicField({ block, onUpdate }) {
  return (
    <input
            className="font-code bg-transparent border-none outline-none font-bold text-[15px] text-white focus:text-blue-200 transition-colors w-full p-0"
            value={block.data?.name || ''}
...
export function EventField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-2 flex-1 flex-wrap" onMouseDown={(e) => e.stopPropagation()}>
...
export function EmitField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-2 flex-1" onMouseDown={(e) => e.stopPropagation()}>
...
export function InterfaceField({ block, onUpdate }) {
  return (
    <input
...
export function ContractField({ block, onUpdate }) {
  return (
    <div className="flex items-center gap-2 flex-1" onMouseDown={(e) => e.stopPropagation()}>
            <input
...
export function ConstructorField({ block, onUpdate }) {
  return (
...
export function ModifierFunctionConstructorField({ block, onUpdate }) {
  return (
